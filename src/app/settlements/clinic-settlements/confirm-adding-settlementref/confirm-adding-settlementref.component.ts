...
export class ConfirmAddingSettlementrefComponent implements OnInit,AfterViewInit {
  ...
  constructor(private dialog:MatDialog,public dialogRef:MatDialogRef<ClinicSettlementsComponent>,@Inject(MAT_DIALOG_DATA) public data:any,private settlementService:PaymentService, private datePipe:DatePipe, private spinner:SpinnerService){
...
// const worksheet = XLSX.utils.json_to_sheet(this.settlementData);
